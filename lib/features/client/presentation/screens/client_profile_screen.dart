...
class _ClientProfileScreenState extends ConsumerState<ClientProfileScreen> {
  ...
  Future<void> _handleConfirmCancel() async {
    ...
    if (password.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Digite sua senha para confirmar a exclusão')),
      );
      return;
    }
    ...
    return AppCard(
      ...
      child: Column(
        ...
        children: [
          ...
          _infoRow('Tipo de Conta', user?.isClient == true ? 'Cliente' : 'Profissional'),
        ],
      ),
    );
  }
        ...
        children: [
          ...
          if (_isLoadingProfile)
            ...
            if (addr.street.isNotEmpty)
              _infoRow('Rua', '${addr.street}${addr.number.isNotEmpty ? ', ${addr.number}' : ''}'),
  ...
  Widget _buildActions() {
    return Column(
      children: [
        AppButton(
          title: 'Editar Perfil',
          onPressed: () => context.push('${RouteNames.clientProfile}/edit'),
        ...
        AppButton(
          title: 'Alterar Senha',
          onPressed: () =>
              context.push('${RouteNames.clientProfile}/change-password'),
          variant: ButtonVariant.outline,
        ),
        const SizedBox(height: AppSpacing.md),
        AppButton(
